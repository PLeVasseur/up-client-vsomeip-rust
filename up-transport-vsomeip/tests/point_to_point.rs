...
const PTP_UE_ID: u32 = (1 << 16) | 0x2345;
...
fn ptp_reply_uuri() -> UUri {
    UUri::try_from_parts(PTP_AUTHORITY_NAME, PTP_UE_ID, PTP_UE_VERSION_NUMBER, 0).unwrap()
}
    ...
    async fn on_receive(&self, msg: UMessage) {
        ...
        match msg.type_() {
            ...
            UMessageType::Response => {
                ...
                let original_id: Result<UUID, _> = msg.extract_protobuf();
